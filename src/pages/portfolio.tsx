                  ...
                  <div className="main_content float-left w-full">
                    <div className="descriptions float-left w-full">
                      ...
                      <p className="mb-[22px]">
                        ...
                        don&apos;t get much more unusual than These
                        Unprecedented Times. Right now everything counts as out
                        of the ordinary. There are a number of remarkable things
                        about these lockdown days that are worth photographing
                        now so we can remember them when it is all over.
                      </p>
                      ...
                      <p className="mb-[22px]">
                        ...
                        leading lines, the places where one edge meets another
                        in delightful geometric harmony, and how the ordinary
