                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                        }}
                      ></div>
                    </a>
                  </div>
                ...
                <div className="inner relative float-left clear-both h-auto w-full overflow-hidden">
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="abs_image absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-300"
                        // data-img-url="/assets/img/gallery/6.jpg"
                        style={{
                          backgroundImage: `url('/assets/img/gallery/6.jpg')`,
                        }}
                      ></div>
                    </a>
                  </div>
                ...
                <div className="inner relative float-left clear-both h-auto w-full overflow-hidden">
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="abs_image absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-300"
                        // data-img-url="/assets/img/gallery/4.jpg"
                        style={{
                          backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                        }}
                      ></div>
              ...
              <li className="image float-left mb-[40px] w-1/3 pl-[40px]">
                <div className="inner relative float-left clear-both h-auto w-full overflow-hidden">
                  <div
                    ...
                    data-category="Image"
                  >
                    <a className="zoom" href="/assets/img/gallery/3.jpg">
                      <img
                        className="min-w-full opacity-0"
                        src="/assets/img/thumbs/1-1.jpg"
                        alt=""
                      ...
                      <div
                        className="abs_image absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-300"
                        // data-img-url="/assets/img/gallery/3.jpg"
                        style={{
                          backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                        }}
                      ></div>
                ...
                <div className="inner relative float-left clear-both h-auto w-full overflow-hidden">
                  ...
                  >
                    <a className="popup_info" href="#">
                      ...
                      <div
                        className="abs_image absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-300"
                        // data-img-url="/assets/img/gallery/7.jpg"
                        style={{
                          backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                        }}
                      ></div>
                          ...
                          <div className="list_inner relative float-left clear-both h-auto w-full">
                            <div className="my_image relative">
                              ...
                              <div
                                ...
                                // data-img-url="/assets/img/gallery/1.jpg"
                                style={{
                                  backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                                }}
                              ></div>
                        ...
                        <li className="float-left mb-[30px] w-1/2 pl-[30px]">
                          <div className="list_inner relative float-left clear-both h-auto w-full">
                            <div className="my_image relative">
                              ...
                              <div
                                className="main absolute inset-0 bg-cover bg-center bg-no-repeat"
                                // data-img-url="/assets/img/gallery/2.jpg"
                                style={{
                                  backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                                }}
                              ></div>
                ...
                <div className="inner relative float-left clear-both h-auto w-full overflow-hidden">
                  ...
                  >
                    <a className="popup_info" href="#">
                      ...
                      <div
                        className="abs_image absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-300"
                        // data-img-url="/assets/img/gallery/8.jpg"
                        style={{
                          backgroundImage: `url('/assets/img/gallery/5.jpg')`,
                        }}
                      ></div>
